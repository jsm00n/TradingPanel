...
const MessageItem: React.FC<MessageItemProps> = ({ message }) => {
    ...
    return (
        <div className="min-w-[350px] flex-row w-full my-auto bg-watchitem-top-background border-solid border-2 border-button-gray-border rounded-sm h-auto m-md:h-32 pl-4 pr-4 pt-3 pb-2">
            <div className="flex-row m-md:flex w-full justify-between">
                <div className="flex">
                    ...
                    <Label className="my-auto max-w-[50%] ml-2 text-center font-medium text-[11px] m-md:text-[14px] text-card-foreground">DRBT AI Calls</Label>
                ...
                <div className="flex my-auto ml-2 space-x-2">
            ...
            <div className="flex my-auto w-full rounded-sm mt-2 pl-1.5 pr-1.5 pb-1 pt-1 bg-[#262c3f] justify-between">
                <Label className="my-auto text-[11px] m-md:text-[13px] ml-1 font-normal text-white/60">0xEE86283a2DFCc1f52E86790e275e5b07b44A50E5</Label>
                <Button
                    size="icon"
                    variant="ghost"
